(() => {
  ...
  // extensions/my-product-config-extension/src/ProductDetailsConfigurationExtension.js
  ...
  // extensions/my-product-config-extension/src/ProductVariantDetailsConfigurationExtension.js
